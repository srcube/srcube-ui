...
export type DateRangePickerMiniRange = 'start' | 'end';

export type DateRangePickerMiniValue = {
  start: string | null;
  end: string | null;
};

export type DateRangePickerMiniProps = FieldVariants &
  PickerVariants & {
    id?: string;
    label?: string;
    labelPlacement?: 'outside' | 'outside-left' | 'inside';
    value?: DateRangePickerMiniValue | null;
    defaultValue?: DateRangePickerMiniValue | null;
    placeholder?: string;
    description?: string;
    errorMessage?: string;
    isDisabled?: boolean;
...
export const dateRangePickerMiniProps = {
