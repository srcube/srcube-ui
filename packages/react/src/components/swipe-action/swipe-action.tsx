...
import { type SwipeActionVariants, swipeAction } from '@srcube-ui/styles/components/swipe-action';
import type {
...
type SwipeActionSize = NonNullable<SwipeActionVariants['size']>;

function resolveSize(value: unknown): SwipeActionSize {
...
function resolveActionWidth(value: unknown, size: SwipeActionSize): number {
