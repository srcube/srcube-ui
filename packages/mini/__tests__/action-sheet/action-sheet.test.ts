...
import template from '../../src/components/action-sheet/index.wxml?raw';
import { actionSheetMiniProps } from '../../src/components/action-sheet/props';
import {
  ACTION_SHEET_CANCEL_TEXT,
  DEFAULT_ACTION_SHEET_LOCALE,
} from '../../src/components/action-sheet/locale';
