...
import template from '../../src/components/listbox/index.wxml?raw';
...
beforeAll(async () => {
  await import('../../src/components/listbox/index');
});
...
it('uses sibling mini scrollbox component mapping', () => {
  const json = JSON.parse(
    readFileSync('packages/mini/src/components/listbox/index.json', 'utf8'),
  ) as {
