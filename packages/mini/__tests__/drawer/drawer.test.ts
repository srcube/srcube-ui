...
import template from '../../src/components/drawer/index.wxml?raw';
...
beforeAll(async () => {
  await import('../../src/components/drawer/index');
});
...
it('uses sibling mini modal component mapping', () => {
  const json = JSON.parse(
    readFileSync('packages/mini/src/components/drawer/index.json', 'utf8'),
  ) as {
