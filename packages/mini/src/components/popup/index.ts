...
import { popup } from '@srcube-ui/styles/components/popup/style';
import { popupMiniProps } from './props';
...
UIComponent({
  ...
  properties:
    popupMiniProps satisfies WechatMiniprogram.Component.PropertyOption,
  ...
  methods: {
    ...
    handleTouchMoveCapture() {
      // Intentionally empty: `catchtouchmove` on popup root prevents page scroll bleed.
    },
  },
});

export { popup } from '@srcube-ui/styles/components/popup/style';
export type { PopupMiniProps } from './props';
export { popupMiniProps } from './props';
