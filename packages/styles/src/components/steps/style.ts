...
const STEP_COLORS: Array<{
  ...
  },
  {
    ...
    line: "bg-zinc-500",
    title: "text-zinc-100",
    solidIndicator: "border-zinc-700 bg-zinc-700 text-black",
    outlineIndicator: "border-zinc-600 bg-zinc-950 text-black",
    flatIndicator: "border-transparent bg-zinc-800 text-black",
    textIndicator: "border-transparent bg-transparent text-zinc-100",
    twotoneIndicator: "border-zinc-700 bg-zinc-900 text-black",
    dotIndicator: "bg-black",
  },
  {
    tone: "dark",
    color: "primary",
  ...
  },
  {
    ...
    twotoneIndicator:
      "border-secondary-700 bg-secondary-950 text-secondary-100",
