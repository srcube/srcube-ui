...
export const inputOtpStyle = tv({
  ...
  variants: {
    ...
    color: {
      default: {
        box: "bg-slate-50 text-slate-700 border-transparent",
        cursor: "bg-slate-500",
      },
      primary: {
  ...
  compoundVariants: [
    ...
    },
    {
      ...
      tone: "dark",
      class: {
        box: "bg-zinc-900 text-zinc-100 border-transparent",
        cursor: "bg-zinc-200",
      },
    },
    {
      ...
      tone: "dark",
      class: {
        box: "bg-primary-950/80 text-primary-100",
    ...
    },
    {
      ...
      tone: "dark",
      class: {
        box: "bg-secondary-950/80 text-secondary-100",
    ...
    },
    {
      ...
      tone: "dark",
      class: {
        box: "bg-success-950/80 text-success-100",
    ...
    },
    {
      ...
      tone: "dark",
      class: {
        box: "bg-warning-950/80 text-warning-100",
    ...
    },
    {
      ...
      tone: "dark",
      class: {
        box: "bg-danger-950/80 text-danger-100",
