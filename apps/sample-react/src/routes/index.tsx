...
function App() {
  const components: { title: string; to: string }[] = [
    ...
    { title: 'Toaster', to: '/toaster' as const },
    { title: 'Tour', to: '/tour' as const },
    { title: 'Uploader', to: '/uploader' as const },
  ];
